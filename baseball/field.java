...
public class field extends JPanel{
	...
	public field(baseballGame game) {
...
//		    private Label label2;
		    ...
		    public void setBoard() {
		        ...
		        scoreLabel1 = new Label();
		        //label2.setBounds(200, 100, 300, 300);
		        int bufferI = game.getScoreBoard(0, 0) + game.getScoreBoard(0, 1) + game.getScoreBoard(0, 2);
		        String bufferS = game.getScoreBoard(0, 0) + "    " + game.getScoreBoard(0, 1) + "    " + game.getScoreBoard(0, 2) + "                                       " + bufferI + "    " +game.getTeam1().getHits();
		        scoreLabel1.setFont(new Font("Dialog", Font.PLAIN, 18));
		        scoreLabel1.setText(bufferS);
		        scoreLabel1.setForeground(Color.green);
		        ...
		        scoreLabel2 = new Label();
		        //label2.setBounds(200, 100, 300, 300);
		        bufferI = game.getScoreBoard(1, 0) + game.getScoreBoard(1, 1) + game.getScoreBoard(1, 2);
		        bufferS = game.getScoreBoard(1, 0) + "    " + game.getScoreBoard(1, 1) + "    " + game.getScoreBoard(1, 2) + "                                       " + bufferI + "    " +game.getTeam2().getHits();
		        scoreLabel2.setFont(new Font("Dialog", Font.PLAIN, 18));
		        scoreLabel2.setText(bufferS);
		        scoreLabel2.setForeground(Color.green);
